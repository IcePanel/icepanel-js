# Reference
## Adrs
<details><summary><code>client.adrs.<a href="/src/api/resources/adrs/client/Client.ts">list</a>({ ...params }) -> core.Page&lt;IcePanel.Adr, IcePanel.AdrsListResponse&gt;</code></summary>
<dl>
<dd>
...
```typescript
const pageableResponse = await client.adrs.list({
...
let page = await client.adrs.list({
    landscapeId: "landscapeId",
    versionId: "latest"
});
