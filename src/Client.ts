...
import { AdrsClient } from "./api/resources/adrs/client/Client.js";
...
export class IcePanelClient {
    ...
    protected _adrs: AdrsClient | undefined;
    ...
    public get adrs(): AdrsClient {
        return (this._adrs ??= new AdrsClient(this._options));
    }
