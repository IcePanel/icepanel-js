...
export class AdrsClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<IcePanel.Adr, IcePanel.AdrsListResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (request: IcePanel.AdrsListRequest): Promise<core.WithRawResponse<IcePanel.AdrsListResponse>> => {
                const { landscapeId, versionId, filter, cursor, limit } = request;
        ...
        return new core.Page<IcePanel.Adr, IcePanel.AdrsListResponse>({
            response: dataWithRawResponse.data,
            rawResponse: dataWithRawResponse.rawResponse,
            hasNextPage: (response) =>
                response?.nextCursor != null &&
                !(typeof response?.nextCursor === "string" && response?.nextCursor === ""),
            getItems: (response) => response?.adrs ?? [],
            loadPage: (response) => {
